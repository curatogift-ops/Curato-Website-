  ...
  return (
    <section id="occasions" className="py-16 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6" suppressHydrationWarning>
          {occasions.map((occasion, index) => (
            <div key={index} className="group flex flex-col items-center" suppressHydrationWarning>
              <div className="relative w-full aspect-square max-w-[170px] sm:max-w-[200px] lg:max-w-[220px] rounded-full overflow-hidden ring-1 ring-black/10 bg-[#f7f7f7] transition-transform duration-300 group-hover:scale-105 group-hover:ring-[#d4af37] mx-auto" suppressHydrationWarning>
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/10 to-transparent" suppressHydrationWarning></div>
              </div>
