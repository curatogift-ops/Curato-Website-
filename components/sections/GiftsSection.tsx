  ...
  return (
    <section className="py-16 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4" suppressHydrationWarning>
          {giftCategories.map((category, index) => (
            ...
            >
              ...
              <div className="relative w-full h-[180px] sm:h-[200px] md:h-[220px] lg:h-[240px] xl:h-[260px] overflow-hidden" suppressHydrationWarning>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent p-3 sm:p-4 flex justify-between items-center z-10" suppressHydrationWarning>
